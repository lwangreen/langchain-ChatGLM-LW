...
历史问题：
{history}
根据上述已知信息和历史问题，详细和专业的来回答用户的本次问题。如果无法从中得到答案，请说 “无法回答该问题” 或 “没有提供足够的相关信息”，不允许在答案中添加编造成分，答案请使用中文。 请结合历史问题回答以下问题：{question}"""

# # 基于上下文的prompt模版，请务必保留"{question}"和"{context}"
# PROMPT_TEMPLATE = """[已知信息]
# {context} 

# 根据上述[已知信息]，详细和专业的来回答用户的[问题]。如果无法从中得到答案，请说 “无法回答该问题” 或 “没有提供足够的相关信息”，不允许在答案中添加编造成分，答案请使用中文。 
...
# 根据上述[已知信息]和[历史问题]，详细和专业的来回答用户的[本次问题]。如果无法从中得到答案，请说 “无法回答该问题” 或 “没有提供足够的相关信息”，不允许在答案中添加编造成分，答案请使用中文。 
